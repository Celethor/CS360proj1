...
&markers=color:green|Huntington+North+High+School*/
...
public class MapBuilder {
    ...
    private String markerColor = "color:green";
    ...
    public void BuildURL(){
        ...
        finalURL = finalURL + beginURL + connect + center + host + connect + zoom + zoomLevel + size + connect + 
        		markers + markerSize + pipeChar + markerColor + pipeChar + host + connect + mapType;
